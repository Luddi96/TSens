...
void loop() {
  ...
  uint8_t tx_arr[] = {0x00, MODULE_ID, 0x01, msb(tx_temp), lsb(tx_temp), 0x02, msb(tx_hum), lsb(tx_hum), 0x03, msb(tx_press), lsb(tx_press), 0x05, tx_batt, 0x0D, tx_runtime, 0xFF};
